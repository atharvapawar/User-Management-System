...
if (!isset($_SESSION['adminid']) || strlen($_SESSION['adminid']) == 0) {
    ...
    if (isset($_GET['id'])) {
        ...
        if ($msg) {
            echo "<script>alert('Data deleted successfully'); window.location.href='manage-users.php';</script>";
        } else {
            echo "<script>alert('Error deleting data'); window.location.href='manage-users.php';</script>";
        }
    }
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Yesterday Registered Users | User Management System</title>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php 
                                    $ret = mysqli_query($con, "SELECT * FROM users WHERE DATE(posting_date) = CURDATE() - INTERVAL 1 DAY");
                                    $cnt = 1;
