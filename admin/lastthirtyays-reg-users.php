...
<head>
    ...
    <title>Registered Users in Last 30 Days | User Management System</title>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i> Registered Users in Last 30 Days
                        </div>
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    $ret = mysqli_query($con, "SELECT * FROM users WHERE DATE(posting_date) >= CURRENT_DATE() - INTERVAL 30 DAY");
                                    $cnt = 1;
