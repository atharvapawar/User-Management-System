...
if (strlen($_SESSION['adminid']) == 0) {
    ...
    $searchkey = mysqli_real_escape_string($con, $_POST['searchkey']);
?>
    <!DOCTYPE html>
    <html lang="en">
    ...
    <head>
        ...
        <title>Search Results | User Management System</title>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i> Search Results
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM users WHERE fname LIKE '%$searchkey%' OR email LIKE '%$searchkey%' OR contactno LIKE '%$searchkey%'";
